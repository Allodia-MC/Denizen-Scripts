...
#   holograms for nodes using entitytags + armor stands and the spawn command
#   resource collecting animations with the animate command + ARM_SWING & sounds for breaking things
#   look into showfakes, to show broken blocks or empty ores for the players
#
